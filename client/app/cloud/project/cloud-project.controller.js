...
angular.module("managerApp")
  .controller("CloudProjectCtrl", function ($scope, $state, $stateParams, $rootScope, $transitions, OvhApiCloud, CloudProjectRightService) {
    var self = this;
    ...
    function init () {
        ...
        _stateChangeListener = $transitions.onStart({}, function (transition) {
